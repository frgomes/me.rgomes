 ...
 */
//TODO @ThreadSafety(level=ThreadSafetyLevel.NOT_THREADSAFE)
       ...
       extends InputStream
{
  ...
  public void reset()
         throws IOException
  {
    throw new IOException("The aggregate input stream does not support the use of mark and reset functionality.");
  }
